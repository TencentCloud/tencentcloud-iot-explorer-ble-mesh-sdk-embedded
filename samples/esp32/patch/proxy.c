...
static struct bt_mesh_proxy_client {
	...
	u16_t filter[MYNEWT_VAL(BLE_MESH_PROXY_FILTER_SIZE)*2];
	enum __packed {
		NONE,
		WHITELIST,
		BLACKLIST,
				  ...
				  struct os_mbuf *msg)
{
	...
	BT_WARN("send --> conn_handle %d type 0x%02x len %u: %s", conn_handle, type, msg->om_len,
